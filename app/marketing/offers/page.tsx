...
export default function OffersPage() {
  ...
  const tabs: DashboardTab[] = cfg.subPages.map(s => ({
    ...
    active: s.href === '/marketing/offers',
  }));
  return (
    <DashboardPage title="Marketing · Products & Offers" subtitle="Packages, retreats, seasonal deals — the sellable inventory." tabs={tabs}>
      <div style={{ gridColumn: '1 / -1' }}>
        <div style={stub}>
          <div style={stubTitle}>Products & Offers</div>
          <div>Packages, retreats, seasonal deals — the sellable inventory.</div>
