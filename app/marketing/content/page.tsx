...
export default function ContentPage() {
  ...
  return (
    <DashboardPage title="Marketing · Content" subtitle="Content library — briefs, calendars, editorial pipeline." tabs={tabs}>
      <div style={{ gridColumn: '1 / -1' }}>
        <div style={stub}>
          <div style={stubTitle}>Content</div>
          <div>Content library — briefs, calendars, editorial pipeline.</div>
