  ...
  return (
    <>
      <PageHeader
        ...
        lede={<>{salesStaff.length > 0 ? `Sales-adjacent staff (${salesStaff.length} of ${staff.length} total)` : `Showing first 30 of ${staff.length} active staff (no sales-coded department found)`} from <code style={{ fontSize: 11 }}>v_staff_register_extended</code>.</>}
      />
