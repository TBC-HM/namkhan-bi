      ...
      <div style={{ background: '#fff', border: '1px solid #e6dfc9', borderRadius: 8, padding: '18px 22px', margin: '8px 0 14px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 14 }}>
          ...
          <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
            ...
            <span style={{ background: '#fff', border: '1px solid #d9d2bc', color: 'var(--ink-soft)', padding: '6px 12px', borderRadius: 4, fontSize: 12 }}>Renew</span>
            <span style={{ background: '#fff', border: '1px solid #d9d2bc', color: 'var(--ink-soft)', padding: '6px 10px', borderRadius: 4, fontSize: 12 }}>⋯</span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 4, borderBottom: '1px solid #e6dfc9', marginTop: 18, marginBottom: -1 }}>
          {TABS.map((t, i) => {
            const active = i === 0;
            return (
              <span key={t} style={{ padding: '8px 14px', fontSize: 12.5, color: active ? 'var(--ink-soft)' : 'var(--ink-mute)', borderBottom: active ? '2px solid #a17a4f' : '2px solid transparent', fontWeight: active ? 600 : 400 }}>
                {i + 1}. {t}
              </span>
            );
          })}
