...
const ATTN_KEY  = 'nk.sales.entry.attention.v2';
const DOCS_KEY  = 'nk.sales.entry.docs.v2';
const TASKS_KEY = 'nk.sales.entry.tasks.v2';
...
const DEFAULT_DOCS: DocItem[] = [
  { id: 'd1', label: 'Revenue Strategy 2025',      href: '/sales/strategy'    },
  { id: 'd2', label: 'Channel Mix Report — Apr 26', href: '/sales/channel-mix' },
  { id: 'd3', label: 'BAR Rate Grid',               href: '/sales/bar'         },
];
...
export default function RevenuePage() {
  ...
  function submitChat(e: React.FormEvent) {
    ...
    if (!q) return;
    router.push(`/cockpit/chat?q=${encodeURIComponent(q)}&dept=sales`);
  }
  ...
  function addDoc() {
    ...
    if (!label) return;
    const href = prompt('Link URL', '/sales/') || '/sales/';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          Ask Mercer anything about sales.
        </div>
