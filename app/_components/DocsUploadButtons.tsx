...
export default function DocsUploadButtons({ compact = false }: { compact?: boolean }) {
  return (
    <div style={{ display:'flex', gap:8 }}>
      <Link href="/marketing/docs/upload" style={{ padding: compact ? '5px 12px' : '6px 14px', fontSize: compact ? 11 : 12, fontWeight:600, background:GREEN, color:'#FFFFFF', border:'1px solid '+GREEN, borderRadius:4, textDecoration:'none' }}>
        + Upload doc
      </Link>
