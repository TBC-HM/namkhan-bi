...
// app/cockpit-v2/knowledge/KnowledgeView.tsx
...
// role. Save sends to /api/cockpit-v2/prompt with dry_run=true first; the
...
function PromptEditor({
  ...
  async function preview() {
    ...
    setPreviewMsg(null);
    try {
      const r = await fetch('/api/cockpit-v2/prompt', {
        method: 'POST',
