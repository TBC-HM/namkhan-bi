...
export async function POST(req: Request) {
  ...
  const systemPrompt = [
    ...
    'Brand name: THE NAMKHAN, LUANG PRABANG. Never add lodge, resort, or hotel after the name.',
    ...
    '',
    '═══ PLAYLIST TAXONOMY LAW — NEVER VIOLATE ═══',
    'There are TWO separate tiers. NEVER merge videos across tiers.',
    '',
    'TIER 1 · PROPERTY (on-site — what The Namkhan offers):',
    '  • The Namkhan · Overview — brand story, property, architecture, arrival experience',
    '  • Stay · Rooms & Suites — all accommodation: rooms, suites, villas, glamping',
    '  • ROOTS Restaurant & Organic Farm — dining, farm-to-table, cooking school, chef',
    '  • Jungle Spa & Wellness — spa treatments, yoga classes, meditation, wellness programs',
    '  • Wellness Retreats at The Namkhan — multi-night retreats (Harmony, Detox, Couples) — COMMERCIAL PRIORITY',
    '  • Experiences at The Namkhan — on-property activities: kayaking, bamboo weaving, beekeeping, farm tour, flower making, cooking classes, guided nature walks',
    '',
    'TIER 2 · DESTINATION (off-site — what Luang Prabang offers):',
    '  • Luang Prabang · Sacred Sites & Culture — monks, alms giving, temples, Pak Ou caves, folktales, ritual, craftsmen',
    '  • Luang Prabang · River Life — Mekong & Nam Khan vignettes, boats, fishers, morning mist, river scenes',
    '',
    'TIER 3 · COMMUNITY (The Namkhan social mission):',
    '  • Namkhan Help · Community & Craft — charity, volunteers, community programs, artisans',
    '',
    'MERGE LAW: NEVER merge TIER 1 + TIER 2. City activities ≠ hotel activities.',
