...
// app/(cockpit)/_design/PickupTabs.tsx
// 2 tabs in one box: "Pickup" + "Cancellations". Server pre-renders both data
// sets and passes them as serialized rows; this client component handles the
// tab toggle. Promoted from /revenue/pulse/_components on 2026-05-23.
            ...
            <tbody>
              ...
              {active.length > 1 && (
                <tr style={{ borderTop: '2px solid var(--ink, #1B1B1B)', background: '#FAFAF7' }}>
                  ...
                  <td style={tdR}>—</td>
                  <td style={{ ...tdR, fontWeight: 600 }}>—</td>
                  <td style={tdR}>—</td>
                </tr>
              )}
            </tbody>
