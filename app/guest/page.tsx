...
const ATTN_KEY  = 'nk.guest.entry.attention.v2';
const DOCS_KEY  = 'nk.guest.entry.docs.v2';
const TASKS_KEY = 'nk.guest.entry.tasks.v2';
...
const DEFAULT_DOCS: DocItem[] = [
  { id: 'd1', label: 'Revenue Strategy 2025',      href: '/guest/strategy'    },
  { id: 'd2', label: 'Channel Mix Report — Apr 26', href: '/guest/channel-mix' },
  { id: 'd3', label: 'BAR Rate Grid',               href: '/guest/bar'         },
];
...
// 2026-05-08 (ticket #328 follow-up): chips + dropdown rewired to /guest sub-pages.
const QUICK_CHIPS = [
...
export default function RevenuePage() {
  ...
  function submitChat(e: React.FormEvent) {
    ...
    if (!q) return;
    router.push(`/cockpit/chat?q=${encodeURIComponent(q)}&dept=guest`);
  }
  ...
  function addDoc() {
    ...
    if (!label) return;
    const href = prompt('Link URL', '/guest/') || '/guest/';
