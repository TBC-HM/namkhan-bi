// app/holding/legal/contracts/page.tsx
  ...
  return (
    <div style={{ background: '#FFFFFF', minHeight: '100vh' }}>
      <DashboardPage
        ...
        action={
          <Link href="/holding/legal/contracts/new" style={primaryBtn}>New revenue contract</Link>
        }
      >
                    ...
                    return (
                      <tr key={r.agreement_id} style={{ borderTop: '1px solid #F5F0E1' }}>
                        <td style={{ ...td, fontFamily: 'monospace' }}>
                          <Link href={`/holding/legal/contracts/${r.agreement_id}`} style={{ color: '#084838', textDecoration: 'none' }}>
                            {r.agreement_code}
                          </Link>
                        </td>
