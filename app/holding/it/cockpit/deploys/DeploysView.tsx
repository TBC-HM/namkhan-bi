...
const SMOKE_ROUTES = [
  '/holding/it/cockpit/team',
  '/holding/it/cockpit/tasks',
  '/holding/it/cockpit/chat',
  '/holding/it/cockpit/notify',
  '/holding/it/cockpit/users',
  '/holding/it/cockpit/health',
  '/holding/it/cockpit/deploys',
  '/holding/it/cockpit/cost',
];
