...
const PLATFORM_TOOLS = [
  ...
  { slug: 'openai_gpt',      name: 'OpenAI GPT-4o (text)',          purpose: 'Text reasoning · ChatGPT-grade intelligence · fallback or specialist tasks',       vault: 'OPENAI_API_KEY',            status: 'pending', note: 'Separate from gpt-image-1. GPT-4o for complex reasoning, multilingual comms, fallback LLM.' },
  { slug: 'mistral_ai',       name: 'Mistral AI',                    purpose: 'Fast inference · multilingual · high-volume classification · low cost',            vault: 'MISTRAL_API_KEY',           status: 'pending', note: 'Best for: Lao/Thai/Chinese guest comms, high-volume tasks. Very fast inference.' },
  { slug: 'google_gemini_pro',name: 'Google Gemini Pro',             purpose: 'Gemini 1.5 Pro · multimodal · 1M token context · video understanding',            vault: 'GEMINI_API_KEY',            status: 'pending', note: 'Via Google AI Studio or Vertex AI. Best for very long documents, video.' },
  { slug: 'deepseek',         name: 'DeepSeek',                      purpose: 'High-capability reasoning · strong at code + analysis · low cost',                vault: 'DEEPSEEK_API_KEY',          status: 'pending', note: 'DeepSeek-V3/R1. Comparable to GPT-4o at ~10% cost for bulk analytical tasks.' },
