...
// app/holding/it2/modules/intake/SpecBuilderClient.tsx
...
- Read \`documentation.documents\` where \`doc_type='design_system'\` (v14+) before touching any UI. Live gallery: /holding/it2/knowledge/design
    ...
    return (
      <div style={{ padding: '32px 24px', maxWidth: 720 }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <button style={{ ...S.submitBtn, background: '#5A5A5A' }} onClick={() => router.push('/holding/it2/modules/specs')}>View all specs</button>
        </div>
      </div>
    );
  }
