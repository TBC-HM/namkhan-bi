...
// app/holding/it2/fleet/team/agent/[role]/runs/RunsView.tsx
  ...
  return (
    <div style={{ color: TOKENS.text }}>
      <header style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 14, flexWrap: 'wrap' }}>
        <Link href={`/holding/it2/fleet/team/agent/${role}`} style={{ fontFamily: MONO, fontSize: 11, color: TOKENS.text3, textDecoration: 'none' }}>
