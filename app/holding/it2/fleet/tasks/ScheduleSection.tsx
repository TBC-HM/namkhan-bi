// app/holding/it2/fleet/tasks/ScheduleSection.tsx
// Scheduler Console v2 (brief ops-scheduler-console-v1, goal 47), folded into
// IT2 Fleet → Tasks per it-area-reorg-v1 ("Tasks (+Schedule folded)"); formerly
// the standalone /holding/it/cockpit/schedule page — deepens
