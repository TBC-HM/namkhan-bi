...
// PBS 2026-07-09 pm: SOP send — pick recipient email, relay to send-report-email edge fn.
  ...
  return (
    <div style={{ padding: 24, background: '#FFFFFF', color: '#1B1B1B', fontFamily: '-apple-system, Helvetica, Arial, sans-serif', minHeight: '100vh' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <SopSendForm sopCode={row.sop_code} defaultSubject={`SOP · ${row.title}`} preview={row.short_summary ?? row.body_md ?? ''} />
      </div>
    </div>
  );
}
