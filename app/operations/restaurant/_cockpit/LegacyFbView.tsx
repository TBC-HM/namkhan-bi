// app/operations/restaurant/_cockpit/LegacyFbView.tsx
// PBS 2026-08-26 · The previous F&B page, preserved whole.
//
// This was app/operations/restaurant/page.tsx — the USALI rollup, the QB GL
// reconciliation, the breakfast fair-value reclass and the operating snapshot.
// It is a controller's view, so it moved behind the cockpit's Ledger tab
// rather than opening the page. NOTHING was deleted: every container, query
// and figure is unchanged. Only the DashboardPage wrapper is gone, because
// the cockpit shell supplies it now.
...
export default async function LegacyFbView({ searchParams, propertyId }: Props) {
