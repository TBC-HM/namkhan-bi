...
// Revenue dept entry — proper landing per master design directive 2026-05-08.
// Replaces the 12-line redirect-only stub. Lands the user with greeting,
// 4-tile KPI strip, and a sub-page chip grid that links to every existing
// revenue surface.
//
// Sub-pages preserved (every link below routes to a real page on main):
//   pulse, pace, channels, pricing, rateplans, compset, parity, agents,
//   demand, promotions, inventory.
