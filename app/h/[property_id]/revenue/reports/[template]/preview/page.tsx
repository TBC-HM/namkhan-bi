// Multi-tenant delegate for the Revenue HoD scheduled reports preview page.
// URL: /h/{property_id}/revenue/reports/{template}/preview
// Reuses the base preview page and pins property_id from the route param.
// 2026-07-08
