// app/h/[property_id]/operations/inventory/orders/[po_id]/page.tsx
...
import NamkhanPoDetail from '@/app/operations/inventory/orders/[po_id]/page';

export const dynamic = 'force-dynamic';
export const revalidate = 0;

interface Params { property_id: string; po_id: string }
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanPoDetail params={{ po_id: params.po_id }} />;
}
