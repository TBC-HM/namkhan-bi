      ...
      {tab === 'revenue' && (
        <div role="tabpanel">
          ...
          <div className="grid gap-px border border-neutral-200 bg-neutral-200 md:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Reputation vs goals MOVED to Operations > Quality > Guest signal,
                PBS 2026-09-14: "this is a very important kpi container for quality".
                Not duplicated here - one KPI rendered on two surfaces is how the two
                start disagreeing about the same number. It still reads the same view,
                public.v_mkt_dash_reputation; only the tile moved. */}
