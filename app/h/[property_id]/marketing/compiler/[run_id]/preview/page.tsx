// app/h/[property_id]/marketing/compiler/[run_id]/preview/page.tsx
...
import NamkhanCompilerPreview from '@/app/marketing/compiler/[run_id]/preview/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanCompilerPreview params={{ run_id: params.run_id }} />;
}
