// app/h/[property_id]/marketing/campaigns/[id]/page.tsx
...
import NamkhanCampaignDetail from '@/app/marketing/campaigns/[id]/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanCampaignDetail params={{ id: params.id }} />;
}
