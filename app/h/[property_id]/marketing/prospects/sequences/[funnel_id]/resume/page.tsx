// app/h/[property_id]/marketing/prospects/sequences/[funnel_id]/resume/page.tsx
...
import NamkhanSeqResume from '@/app/marketing/prospects/sequences/[funnel_id]/resume/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanSeqResume params={{ funnel_id: params.funnel_id }} />;
}
