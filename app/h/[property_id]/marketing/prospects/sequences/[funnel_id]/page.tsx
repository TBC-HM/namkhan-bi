// app/h/[property_id]/marketing/prospects/sequences/[funnel_id]/page.tsx
...
import NamkhanSeq from '@/app/marketing/prospects/sequences/[funnel_id]/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanSeq params={{ funnel_id: params.funnel_id }} />;
}
