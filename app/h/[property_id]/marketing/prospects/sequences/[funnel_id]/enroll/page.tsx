// app/h/[property_id]/marketing/prospects/sequences/[funnel_id]/enroll/page.tsx
...
import NamkhanSeqEnroll from '@/app/marketing/prospects/sequences/[funnel_id]/enroll/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanSeqEnroll params={{ funnel_id: params.funnel_id }} />;
}
