// app/h/[property_id]/marketing/prospects/sequences/[funnel_id]/preview/page.tsx
...
import NamkhanSeqPreview from '@/app/marketing/prospects/sequences/[funnel_id]/preview/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanSeqPreview params={{ funnel_id: params.funnel_id }} />;
}
