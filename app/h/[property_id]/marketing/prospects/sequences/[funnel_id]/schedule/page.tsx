// app/h/[property_id]/marketing/prospects/sequences/[funnel_id]/schedule/page.tsx
...
import NamkhanSeqSchedule from '@/app/marketing/prospects/sequences/[funnel_id]/schedule/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanSeqSchedule params={{ funnel_id: params.funnel_id }} />;
}
