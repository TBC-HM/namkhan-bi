// app/h/[property_id]/marketing/prospects/sequences/[funnel_id]/delete/page.tsx
...
import NamkhanSeqDelete from '@/app/marketing/prospects/sequences/[funnel_id]/delete/page';
...
export default function DonnaDelegatePage({
  ...
  return <NamkhanSeqDelete params={{ funnel_id: params.funnel_id }} />;
}
