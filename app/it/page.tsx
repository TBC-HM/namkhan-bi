...
const ATTN_KEY  = 'nk.it.entry.attention.v2';
const DOCS_KEY  = 'nk.it.entry.docs.v2';
const TASKS_KEY = 'nk.it.entry.tasks.v2';
...
const DEFAULT_DOCS: DocItem[] = [
  { id: 'd1', label: 'Revenue Strategy 2025',      href: '/it/strategy'    },
  { id: 'd2', label: 'Channel Mix Report — Apr 26', href: '/it/channel-mix' },
  { id: 'd3', label: 'BAR Rate Grid',               href: '/it/bar'         },
];
...
export default function RevenuePage() {
  ...
  function submitChat(e: React.FormEvent) {
    ...
    if (!q) return;
    router.push(`/cockpit/chat?q=${encodeURIComponent(q)}&dept=it`);
  }
  ...
  function addDoc() {
    ...
    if (!label) return;
    const href = prompt('Link URL', '/it/') || '/it/';
