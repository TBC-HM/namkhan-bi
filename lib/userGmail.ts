...
// 2026-08-14 (unstick-sweep STEP 3B repair): commit cc4d442b51 replaced this 26.8 KB helper
// library with an 18.7 KB rewrite (+241/-459), silently deleting replyToMessage,
// listMessagesInLabel, trashMessage, getAttachmentBytes, listLabels, modifyLabelsForUser and
// breaking tsc on main across 8 mail routes (truncation disease, memory 767). Restored
// byte-exact from parent 24dd23ef and re-appended the one intended addition below.
