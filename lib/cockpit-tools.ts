...
const ALLOWED_VIEWS = new Set([
  ...
  "v_it_weekly_digest",
  "v_donna_pay_summary",
  // ─── Revenue HoD (Vector) scope expansion — 2026-07-16 ──────────────────
  // Vector reported "pickup views aren't available" when asked about today's
  // channel-source pickup. Adding the granular revenue surface used by /revenue/*
  // pages: pickup (day/30d/monthly/velocity), pace curves, channel performance,
  // room-type performance, source top10, rate discipline, and reservations base.
  // Read-only — supabase_execute_sql also enforces DROP/TRUNCATE/DELETE guard.
  "v_pickup_day_report",
  "v_pickup_30d",
  "v_pickup_monthly",
  "v_pickup_velocity_28d",
  "v_pickup_velocity_15d30d",
  "mv_pace_otb",
  "v_pace_curve",
  "v_pace_by_ci_month",
  "kpi.v_pace_otb_daily",
  "v_channel_mix_30d",
  "v_channel_summary",
  "v_channel_performance_monthly",
  "kpi.v_channel_performance_monthly",
  "v_channels_all_time_trend",
  "v_channel_nights_daily",
  "v_source_top10",
  "v_source_top10_otb_vs_sdly",
  "v_source_bookings",
  "v_country_channel_crosstab",
  "v_monthly_adr_by_channel",
  "v_monthly_adr_by_channel_room",
  "kpi.v_adr_daily",
  "kpi.v_revpar_daily",
  "kpi.v_occupancy_daily",
  "v_room_type_performance_monthly",
  "v_room_type_pulse_30d",
  "v_room_type_pulse_7d",
  "v_room_type_pulse_90d",
  "v_room_type_units",
  "v_lead_time_buckets",
  "v_lead_time_by_channel_daily",
  "kpi.v_lead_time_analytics_daily",
  "v_rate_plan_perf",
  "v_rate_plan_performance_monthly",
  "v_rate_plan_hygiene",
  "v_rate_plans_all",
  "v_rate_matrix_today",
  "v_rate_integrity",
  "v_dmc_performance",
  "kpi.v_dmc_performance",
  "v_bedbank_rate_leakage",
  "v_reservations_unified",
  "pms.v_reservations",
  "pms.v_reservation_rooms",
...
export const CHAT_MODE_TOOLS: AgentToolDef[] = [
  ...
  },
  {
    ...
    description: 'Read live data from any allowlisted Supabase view/table. Use this PROACTIVELY whenever PBS asks about live state (KPIs, tickets, bugs, KB, agents, etc.) instead of saying you need to switch modes. Allowlist (2026-07-16 revenue expansion): (KPI/finance) mv_kpi_today, v_kpi_daily, v_revenue_usali, kpi.v_occupancy_base, kpi.v_capture_rate_daily, kpi.v_ancillary_daily, v_adr_revpar, v_payroll_loader, v_channel_economics, v_finance_cash_forecast, v_finance_budget_vs_actual, v_payroll_dept_monthly, v_it_weekly_digest, v_donna_pay_summary; (pickup/pace) v_pickup_otb, v_pickup_day_report, v_pickup_30d, v_pickup_monthly, v_pickup_velocity_28d, v_pickup_velocity_15d30d, v_otb_pace, mv_pace_otb, v_pace_curve, v_pace_by_ci_month, kpi.v_pace_otb_daily; (channel/source) v_channel_mix, v_channel_mix_30d, v_channel_summary, v_channel_performance_monthly, kpi.v_channel_performance_monthly, v_channels_all_time_trend, v_channel_nights_daily, v_source_top10, v_source_top10_otb_vs_sdly, v_source_bookings, v_country_channel_crosstab, v_monthly_adr_by_channel, v_monthly_adr_by_channel_room, kpi.v_adr_daily, kpi.v_revpar_daily, kpi.v_occupancy_daily; (room/rate) v_room_type_performance_monthly, v_room_type_pulse_30d, v_room_type_pulse_7d, v_room_type_pulse_90d, v_room_type_units, v_lead_time_buckets, v_lead_time_by_channel_daily, kpi.v_lead_time_analytics_daily, v_rate_plan_perf, v_rate_plan_performance_monthly, v_rate_plan_hygiene, v_rate_plans_all, v_rate_matrix_today, v_rate_integrity, v_dmc_performance, kpi.v_dmc_performance, v_bedbank_rate_leakage; (base) v_reservations_unified, pms.v_reservations, pms.v_reservation_rooms; (cockpit) v_compset_set_summary, v_dq_open, v_pl_monthly_usali, v_tactical_alerts_top, v_unanswered_threads, v_agent_health, v_kit_performance, cockpit_bugs, cockpit_tickets, cockpit_proposals, cockpit_audit_log, cockpit_incidents, cockpit_kpi_snapshots, frameworks, framework_items, scoring_model, lead_scraping_fields. For KB entries use read_knowledge_base (cockpit.kn_agent_memory).',
    input_schema: {
      type: 'object',
      properties: {
