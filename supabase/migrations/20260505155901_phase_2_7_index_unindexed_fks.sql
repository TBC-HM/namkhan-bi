...
-- Version: 20260505155901
-- Name:    phase_2_7_index_unindexed_fks
-- Source:  prod kpenyneooigsyuuomgct (canonical)
-- Method:  supabase db dump --data-only --schema supabase_migrations + parse + split


-- =====================================================================
-- PHASE 2.7 — Auto-create indexes for all unindexed foreign keys.
-- =====================================================================
...
BEGIN
  ...
  LOOP
    ...
    END;
  END LOOP;
  RAISE NOTICE 'Created % indexes', total;
END $$;
