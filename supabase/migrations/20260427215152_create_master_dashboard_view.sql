...
-- Version: 20260427215152
-- Name:    create_master_dashboard_view
-- Source:  prod kpenyneooigsyuuomgct (canonical)
-- Method:  supabase db dump --data-only --schema supabase_migrations + parse + split

-- Master operational view: one query = full system status
...
-- Quick test
SELECT pipeline_health, dq_alerts FROM dq.v_dashboard;