...
-- Version: 20260427201556
-- Name:    fix_dq_run_function
...
BEGIN
  ...
  -- R-001: No reservations modified in last 6 hours (uses updated_at)
  ...
  -- R-004: Reservation has no rooms (status not cancelled)
  INSERT INTO dq.violations (rule_id, severity, entity_type, entity_id, details)
  ...
  -- R-010: Transaction missing item_category
  INSERT INTO dq.violations (rule_id, severity, entity_type, details)
  ...
  -- R-013, R-014: Reconciliation gaps (excluding partial current month)
  INSERT INTO dq.violations (rule_id, severity, entity_type, entity_id, details)
  SELECT 
  ...
  -- R-018: Revenue drop > 50% MoM (excluding partial current month)
  INSERT INTO dq.violations (rule_id, severity, entity_type, entity_id, details)
  ...
  FROM (
    SELECT 
      period_year, period_month, amount_usd,
  ...
  -- H-001: Reservation with same arrival = departure date
  INSERT INTO dq.violations (rule_id, severity, entity_type, entity_id, details)
  ...
  -- H-002: Channel concentration > 70% (last 90 days)
  INSERT INTO dq.violations (rule_id, severity, entity_type, details)
  ...
  -- H-003: Cancellation rate > 25% (last 90 days)
  INSERT INTO dq.violations (rule_id, severity, entity_type, details)
