...
-- Version: 20260504184223
-- Name:    2026_05_04_parity_check_fix_ambiguous
-- Source:  prod kpenyneooigsyuuomgct (canonical)
-- Method:  supabase db dump --data-only --schema supabase_migrations + parse + split


DROP FUNCTION IF EXISTS public.parity_check_internal();
...
BEGIN
  ...
  jumps AS (
    ...
    FROM today t
    JOIN yesterday y
      ON y.comp_id   = t.comp_id
     AND y.stay_date = t.stay_date
     AND y.channel   = t.channel
     AND y.raw_label = t.raw_label
