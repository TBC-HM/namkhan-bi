...
export const LLM_MODELS = [
  ...
  },
  {
    ...
    cost: '$0.08/M',
    speed: '⚡⚡⚡',
    bestFor: 'Fastest Claude — quick Q&A, summaries, high-volume tasks',
    special: null,
    recommended: false,
  },
  {
    ...
    cost: '$3.00/M',
    speed: '⚡⚡',
    bestFor: 'Best all-round Claude — nuanced writing, analysis, complex reasoning',
    special: 'Current Claude default · extended thinking',
    recommended: false,
  },
  {
    id: 'gpt-4o-mini',
