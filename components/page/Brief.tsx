...
const S: Record<string, React.CSSProperties> = {
  ...
  good: { background: 'var(--surf-ok, #0a1f12)', border: '1px solid var(--st-good)', borderRadius: 10, padding: '12px 14px' },
  bad:  { background: 'var(--surf-warn, #1f0e0c)', border: '1px solid var(--st-bad)', borderRadius: 10, padding: '12px 14px' },
  goodEyebrow: { fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: 9, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--st-good)', marginBottom: 8 },
  badEyebrow:  { fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: 9, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--st-bad)', marginBottom: 8 },
  list: { listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 6 },
  itemGood: { fontSize: 13, color: 'var(--text-2, #d8cca8)', lineHeight: 1.5, paddingLeft: 12, borderLeft: '2px solid var(--st-good)', paddingTop: 2, paddingBottom: 2 },
  itemBad:  { fontSize: 13, color: 'var(--text-2, #d8cca8)', lineHeight: 1.5, paddingLeft: 12, borderLeft: '2px solid var(--st-bad)', paddingTop: 2, paddingBottom: 2 },
};
