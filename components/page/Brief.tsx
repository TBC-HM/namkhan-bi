...
const S: Record<string, React.CSSProperties> = {
  ...
  eyebrow: {
    ...
    fontSize: 10, letterSpacing: '0.22em', textTransform: 'uppercase', color: '#a8854a',
  },
  line: { fontFamily: "'Fraunces', Georgia, serif", fontStyle: 'italic', fontSize: 22, lineHeight: 1.4, color: '#e9e1ce', marginBottom: 8 },
  body: { fontSize: 14, color: '#c9bb96', lineHeight: 1.6, marginBottom: 14 },
  gbGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 12 },
  good: { background: '#0a1f12', border: '1px solid #1c3526', borderRadius: 10, padding: '12px 14px' },
  bad:  { background: '#1f0e0c', border: '1px solid #5a2825', borderRadius: 10, padding: '12px 14px' },
  ...
  itemGood: { fontSize: 13, color: '#d8cca8', lineHeight: 1.5, paddingLeft: 12, borderLeft: '2px solid #7c9a6b', paddingTop: 2, paddingBottom: 2 },
  itemBad:  { fontSize: 13, color: '#d8cca8', lineHeight: 1.5, paddingLeft: 12, borderLeft: '2px solid #c0584c', paddingTop: 2, paddingBottom: 2 },
};
